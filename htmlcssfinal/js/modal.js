export default class Modal {
  constructor(config) {
    ...
    this.focusElements = ["a[href]", "button", "input", "select", "textarea", "[tabindex]"];
  ...
  onDocumentClick(event) {
    ...
    if (targetButton) {
      ...
      this.modalWindow = document.querySelector(`[data-modal-window="${target}"]`);
  ...
  catchFocus(event) {
    const focusableElements = this.modalWindow.querySelectorAll(this.focusElements);
